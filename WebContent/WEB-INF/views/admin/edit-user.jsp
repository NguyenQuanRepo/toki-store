						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<h3>Người dùng:</h3>
										<form:form action="admin/edit-user.htm" modelAttribute="user" method="post">
											...
											<div class="form-group">
												<label>Mật khẩu:</label> <form:input class="form-control"
													value="${user.password }" type="password" path="password" />
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="checkbox">
													<label> 
														<form:radiobutton value="1" path="roleId" label="Admin"/>
														<br>
														<form:radiobutton value="2" path="roleId" label="Client"/>
													</label> 
												</div>
