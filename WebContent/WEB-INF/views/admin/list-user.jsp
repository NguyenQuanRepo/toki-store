			...
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-12">
										...
										<tbody>
											<c:forEach items="${userList }" var="list">
												<tr class="odd gradeX">
													...
													<td><a
														href="admin/edit-user/${list.id }.htm"
														class="center">Sửa</a> |
														 <a
														href="admin/delete/${list.id }.htm"
						...
						<!--End Advanced Tables -->
						<div class="col-md-13" ><a href="admin/add-user.htm"><button class="btn btn-default1">Thêm người dùng</button></div>
