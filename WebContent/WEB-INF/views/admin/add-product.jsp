							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										...
										<form:form action="admin/add-product.htm" modelAttribute="product" method = "POST">
											<form:hidden path="id"/>
											...
											<div class="form-group">
												<label>Giá:</label> <form:input class="form-control"
													placeholder="Nhập giá sản phẩm" type="number" path="price" />
											</div>
											<div class="form-group">
												<label>Mô tả:</label>
												<br>
												<form:textarea rows="4" cols="50" path="des" id="editer"></form:textarea>
